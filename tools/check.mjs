...
const syntaxFiles = [
  "tests/emptyMarketDisplay.test.mjs",
  "tests/asyncSelection.test.mjs",
  "tools/capture-async-selection.mjs",
  ...
  "src/providerTime.mjs",
  "src/priceObservation.mjs",
  "src/shariaEvidence.mjs",
  "tools/check.mjs",
  ...
  "src/loadEnv.mjs",
  "src/sharedTasks.mjs",
  "src/recommendationPolicy.mjs",
  "tests/sharedTasks.test.mjs",
  "tests/recommendationPolicy.test.mjs",
  "tests/apiClient.test.mjs",
  "tests/production.integration.mjs",
  "tests/providerDeadline.test.mjs",
  "tests/loadEnv.test.mjs",
  "tools/css-audit.mjs",
  "tests/accessibility.test.mjs",
  "tools/capture-home-v3.mjs",
  "tests/release-truthfulness.test.mjs",
  "tests/requestPolicy.test.mjs",
  "tests/layoutStability.test.mjs",
  "tests/detailPageResilience.test.mjs",
  "server.mjs",
  "src/analysis.mjs",
  "src/dataProviders.mjs",
  "src/markets.mjs",
  "src/instrumentCatalog.mjs",
  ...
  "public/modules/html.js",
  "public/modules/marketFeeds.js",
